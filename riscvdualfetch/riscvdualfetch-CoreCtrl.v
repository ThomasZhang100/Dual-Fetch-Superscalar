...
(
  ...
  // Update bubble0 bit when instruction 0 leaves decode stage
  always @ ( posedge clk ) begin
    if( inst0_val_Dhl && !stall_0_Dhl) begin
      bubble0_Dhl <= 1'b1;
    end
  end
  ...
  assign steering_mux_sel_Dhl = !inst0_val_Dhl; 
  ...
  wire stall_0_Dhl = ((stall_X0hl && inst0_val_Dhl) || stall_0_muldiv_use_Dhl || stall_0_load_use_Dhl);
  wire stall_1_Dhl = (inst0_val_Dhl || stall_1_muldiv_use_Dhl || stall_1_load_use_Dhl || (stall_X0hl && inst1_val_Dhl));
  ...
  always @( posedge clk ) begin
    if ( !reset ) begin
      ...
      if ( stats_en || csr_stats ) begin
        ...
        if ( (inst0_val_Dhl && !stall_0_Dhl) || (inst1_val_Dhl && !stall_1_Dhl) ) begin
          num_inst = num_inst + 1;
        end
